...
import backgroundImg from './15.jpg';
    ...
    if (this.state.hasData) {
      return (
        <div className="App" style={sectionStyle}>
          ...
          <div className="h1-responsive font-weight-bold text-center my-5">
              <img src={require('./logo.png')} style={{
                width: '80px', height: '60px', verticalAlign: 'text-bottom', marginRight: '10px'
              }} />
              Buy/Sell Digital Art on Our Art Platform
            </div>
            All the artworks on Artech are real authorized and trackable
        ...
        <div className="App" style={sectionStyle}>
          ...
          <section className="text-center">
            ...
            <div className="h1-responsive font-weight-bold text-center my-5">
              <img src={require('./logo.png')} style={{
                width: '80px', height: '60px', verticalAlign: 'text-bottom',marginRight: '10px'}}/>
              Buy Digital Art on our Art Gallery
            </div>
            All the artworks on Artech are real authorized and trackable
